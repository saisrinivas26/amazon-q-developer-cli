...
use crate::cli::chat::voice::{
    NewVoiceHandler, VoiceSettings, TranscriptionBackend, RichVoiceError,
...
impl VoiceArgs {
    pub async fn execute(self, os: &mut Os, session: &mut ChatSession) -> Result<ChatState, ChatError> {
        ...
        execute!(
            ...
            style::Print(format!("🎤 Activating voice input mode ({})\n", 
        ...
        let mut voice_handler = NewVoiceHandler::new(settings, cache_dir);
            ...
            match action {
                ...
                crate::cli::chat::voice::error::ErrorAction::ConfigureProvider => {
                    execute!(
                        session.stderr,
                        style::SetForegroundColor(Color::Green),
                        style::Print("💡 Run /voice --setup for configuration help\n"),
                    )?;
                }
            }
        }
